	...
	<div class="col-md-3">
		...
		<div class="box-primary">
			<div class="box-body box-prpfile">
				<img class="profile-user-img img-responsive img-circle" src="<?php echo'assets/upload/images/member.jpg'/.$this->session->userdata('photo')); ?>" alt="User profile picture">
				...
				<p class="text-muted text-center"><?php echo $get_all_userdata->name;?></p>
	...
	<div class="col-md-9">
		<div class="nav-tabs-custom">
			<ul class="nav nav-tabs">
				<li class="active"><a href="#settings" data-toggle="tab">Ubah Identitas</a>
				</li>
				<li><a href="#password" data-toggle ="tab">Ubah Password</a>
				</li>
			</ul>
<div class="tab-content">
	<div class="active tab-pane" id="settings">
		<form class="form-horizontal" action="<?php echo base_url('member/Profile')?>"method="POST">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label">Nomor Telpone</label>
				<div class="col-sm-10">
				<input type="text" class="form-control" placeholder="Nama Depan" name="first_
				name" value="<?php echo $this->session->userdata('first_name'); ?>">
				</div>
			</div>
			<div class="form-group">
